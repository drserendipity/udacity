...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed, filename_actor=None, filename_critic=None):
    ...
    def step(self, state, action, reward, next_state, done, time_step):
        ...
        if len(self.memory) > BATCH_SIZE and time_step % LEARN_EVERY == 0:
